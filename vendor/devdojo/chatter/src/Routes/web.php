...
Route::group(['middleware' => 'web'], function () {
	...
	Route::patch('/forums/unlock/{threadid}', 'DevDojo\Chatter\Controllers\ChatterDiscussionController@unlockThread');
	Route::patch('/forums/lock/{threadid}', 'DevDojo\Chatter\Controllers\ChatterDiscussionController@lockThread');
